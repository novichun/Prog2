...
<div class='box'>
  ...
  <div class='box-form'>
    ...
    @enderror
    <p class='field'>
      <label for='user'>Telefonszáma</label>
      <input name="phone" type="text" class="form-control @error('name') is-invalid @enderror" id="name" aria-describedby="name" value="{{ old('name') }}">
@error('phone')
    <span class="invalid-feedback" role="alert">
        {{ $message }}
    </span>
